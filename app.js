...
const DATA_STORE = {
    ...
    mtt: {
        ...
        combo: {
            labels: ['CTL', 'LPS', 'D2.5+G10+L', 'D5+G10+L', 'D10+G10+L', 'D20+G10+L', 'D40+G10+L'],
            data: [100.0, 92.5, 91.2, 93.5, 108.2, 109.5, 107.5],
            desc: "在 LPS 刺激發炎環境下，合併使用 GMI 10 µg/mL 與不同濃度的 DEX，發現細胞活性皆能穩定維持在 90% 以上，高劑量組更因發炎緩解而回升至 100% 以上，顯示該合併配方能有效緩解發炎引發的存活壓力。"
        }
    },
    // IL-6 分泌量數據 (pg/mL)
    il6: {
...
const SIMULATOR_DATABASE = {
    ...
    viability: [
        [100.0, 75.3, 78.2, 75.1, 73.8, 70.2],  // GMI 0
        [100.8, 101.5, 100.2, 100.5, 98.5, 92.4], // GMI 2.5
        [104.5, 92.4, 95.8, 102.1, 100.5, 92.2],  // GMI 5
        [106.2, 91.2, 93.5, 108.2, 109.5, 107.5], // GMI 10
        [110.1, 93.0, 94.0, 106.5, 108.0, 105.0]  // GMI 20
    ]
};
